...
1. Slides **1, 5, 6, 9** from `punk-rock-ai-slide-prompts-zine.md` (title, servers, punk condition, Release Day) — locks look.
2. Hero **A/B/C** from `slides/image-gen-prompts.md` for walk-in / social.
3. Fill slides **2–4, 7–8, 10**; Runway last.
