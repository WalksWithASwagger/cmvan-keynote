# CMVan zine slide prompts (01–15) — adapted from WAIFF Brazil

**Source:** `source-material/waiff-brazil/uai-film-festival-brazil-2026-image-prompts.md` (World AI Film Festival / “How to Keep Our Souls Intact” deck).

**Target event:** Creative Mornings Vancouver — **Punk Rock AI** — **May 1, 2026** field talk. **Release Day** CTA remains **May 29, 2026** (global CREATE activation).

**Design bible:** `source-material/waiff-brazil/BOTH-HANDS-FULL-SLIDES.md` — black / white / red, Xerox grain, collage, no corporate polish.

---

## String substitution table (Brazil → CMVan)

| Original (WAIFF) | CMVan replacement |
|------------------|-------------------|
| `HOW TO KEEP OUR SOULS INTACT` / `WHEN THE MACHINES…` | **`PUNK ROCK AI`** (largest) + subtitle **`XEROX MACHINES · STOLEN WORK · MOST CREATIVE YEAR OF MY LIFE`** (smaller) |
| `WAIFF BRASIL 2026` | **`CMVAN · MAY 1 2026`** (corner stamp) |
| `WHY YOU MAKE FILMS` | **`WHY YOU MAKE`** (or your discipline: art / design / code / music) |
| `Cinema Novo did this first` | Optional: **`VANCOUVER DIDN'T ASK PERMISSION`** or remove if too inside-baseball |
| `OBRIGADO` | **`THANK YOU VANCOUVER`** or **`YOU COMING?`** |
| Node labels FILM CLUB / SURREY etc. | **`VANCOUVER AI`**, **`BC+AI`**, **`MEETUPS`**, **`ETHICS LAB`**, **`COMMUNITY`** — tune to what you will say out loud |

**Story slide (§7):** Brazil used VFX/portrait examples; for CMVan you can swap the three captions to **Matlock / Luke / Belgium** (see `research/research-dossier.md`) while keeping the same visual recipe.

---

## 1. Title slide — Punk Rock AI

**For:** Opening slide (optional alternate to hero prompts in `slides/image-gen-prompts.md`)

**Prompt:**

> Chaotic punk zine cover, dense overlapping collage with ripped magazine clippings, torn film strips, circuit boards, camera parts, newspaper fragments piled on top of each other with visible tape and glue. Halftone dots, ink smudges, coffee stains, staple holes. Black white and blood red only. Xerox grain everywhere. The following text MUST appear prominently in mixed cut-out ransom-note typography at various angles and sizes: "PUNK ROCK AI" as the largest text, and "XEROX MACHINES · STOLEN WORK · MOST CREATIVE YEAR OF MY LIFE" below it, and small stamped text "CMVAN MAY 1 2026" in a corner. Raw handmade zine energy.

---

## 2. Binary trap — Boosters vs doomers

**For:** Act 1 (same as Brazil — universal)
...
**For:** Core framework (same as Brazil)
