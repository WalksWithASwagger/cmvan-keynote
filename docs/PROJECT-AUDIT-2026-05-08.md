...
- `BC-55` / GitHub #138: browser/Lighthouse evidence, `/library` Lighthouse
  coverage, preview-access notes, safe fixes, and follow-up findings landed in
  PR #142; issue #138 is complete.
